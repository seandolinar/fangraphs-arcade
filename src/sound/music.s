...
@instruments:
	.byte $b0 ;instrument 00 (BassBeat)
	.word @env6, @env0, @env7
	.byte $00
	.byte $f0 ;instrument 01 (Harmony)
	.word @env3, @env0, @env0
	.byte $00
	.byte $b0 ;instrument 02 (Lead1)
	.word @env5, @env0, @env0
	.byte $00
	.byte $b0 ;instrument 03 (LeadOut)
	.word @env1, @env0, @env4
	.byte $00
	.byte $b0 ;instrument 04 (Main)
	.word @env3, @env0, @env0
	.byte $00
	.byte $30 ;instrument 05 (NextInningHarmony)
	.word @env2, @env0, @env0
	.byte $00
...
@song0ch1loop:
@ref8:
	.byte $88,$3c,$c3,$54,$a3,$4e,$a3,$4a,$9d,$44,$a3,$4a,$e9,$40,$e7,$00
@ref9:
...
@song1ch0:
	.byte $fb, $01
@ref40:
	.byte $81,$84,$32,$9d,$34,$9b,$36,$8d,$38,$9d,$3a,$8d
@ref41:
	.byte $f9,$00,$83
@song1ch0loop:
@ref42:
...
@song1ch1:
@ref43:
	.byte $84,$4a,$9d,$4c,$9d,$4e,$8d,$50,$9d,$52,$8d
@ref44:
	.byte $f7,$00,$85
@song1ch1loop:
@ref45:
...
@song1ch2:
@ref46:
	.byte $81,$82,$38,$99,$3a,$a1,$3c,$8b,$3e,$9f,$40,$8b
@ref47:
	.byte $9b,$00,$e1
@song1ch2loop:
@ref48:
...
@song3ch0loop:
@ref70:
	.byte $86,$3c,$91,$50,$91,$4c,$91,$4a,$91,$5c,$91,$54,$8f,$58,$91,$5c,$91,$58,$d1,$00,$cb
@ref71:
	.byte $f9,$f9,$cb
	.byte $fd
	.word @song3ch0loop
...
@song3ch1loop:
@ref72:
	.byte $8a,$44,$cd,$52,$cd,$4c,$cd,$00,$cd
@ref73:
	.byte $f9,$f9,$cb
	.byte $fd
	.word @song3ch1loop
