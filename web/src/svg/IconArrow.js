...
export const IconArrow =  () => <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-arrow-up-square-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
